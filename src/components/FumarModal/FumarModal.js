...
import './FumarModal.css';
import { DatePicker } from 'rsuite';
import 'rsuite/dist/rsuite.min.css';
import styles from './FumarModal.module.css';

const FumarModal = ({ isOpen, handleClose, agregarFumar }) => {
    ...
    return (
        <Modal open={isOpen} onClose={handleClose}>
            <Box className={styles.modalBox}>
                ...
                <Typography variant="h6" className={styles.modalTitle}>¿Fumaste?</Typography>
