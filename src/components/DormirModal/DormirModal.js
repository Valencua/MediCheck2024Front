...
import './DormirModal.css';
import { DatePicker } from 'rsuite';
import 'rsuite/dist/rsuite.min.css';
import styles from './DormirModal.module.css';

const DormirModal = ({ isOpen, handleClose, agregarDormir }) => {
    ...
    return (
        <Modal open={isOpen} onClose={handleClose}>
            <Box className={styles.modalBox}>
                ...
                <Typography variant="h6" className={styles.modalTitle}>¿Dormiste 8 horas?</Typography>
