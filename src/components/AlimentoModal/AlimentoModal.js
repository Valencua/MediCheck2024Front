...
import './AlimentoModal.css';
import { DatePicker } from 'rsuite';
import 'rsuite/dist/rsuite.min.css';
import styles from './AlimentoModal.module.css';

const AlimentoModal = ({ isOpen, handleClose, agregarAlimentar }) => {
    ...
    return (
        <Modal open={isOpen} onClose={handleClose}>
            <Box className={styles.modalBox}>
                ...
                <Typography variant="h6" className={styles.modalTitle}>¿Comiste Saludable?</Typography>
